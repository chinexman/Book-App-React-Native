...
// import { useOrientation } from './useOreintation';
import {
  SafeAreaView,
  View,
  Text,
...
const Modaltour = () => {
  ...
  const [orientation, useOreintation] = useState('PORTRAIT');
 ...
 useEffect(() => {
  ...
  return (
    <View style={styles.wholemodal}>
     ...
     { orientation ==='PORTRAIT' && modalnumber === 1 && <Modal
        animationType="fade"
        transparent={true}
        ...
        onRequestClose={() => {
          ...
          {/* {console.log("cool",supportedOrientations)} */}

        <View style={styles.imagebackground}>
          <ImageBackground
            source={require('../../../assets/images/tourscreen.png')}
             style={styles.imagetour}
            // Style={deviceOrientation === "portrait"? Style.portrait : style.landscape}
             imageStyle={{
                //  tintColor: 'rgba(51, 51, 22,0.5)',
              // resizeMode: "stretch",
            //  width:'100%',
            //  height: '100%',
      ...
      { orientation ==='PORTRAIT' && modalnumber === 2 && (
        <Modal
          animationType="fade"
          transparent={true}
          visible={modalVisible}
      ...
      { orientation ==='PORTRAIT' && modalnumber === 3 && (
        <Modal
          animationType="fade"
          transparent={true}
          visible={modalVisible}
      ...
      {orientation ==='PORTRAIT' && modalnumber2 === 4 && (
        <Modal
          animationType="fade"
          transparent={true}
      ...
      { orientation ==='PORTRAIT' && modalnumber2 === 5 && (
        <Modal
          animationType="fade"
          transparent={true}
          visible={modalVisible2}
      ...
      { orientation ==='PORTRAIT' && modalnumber2 === 6 && (
        <Modal
          animationType="fade"
          transparent={true}
          visible={modalVisible2}
      ...
      { orientation ==='PORTRAIT' && modalnumber2 === 7 && (
        <Modal
          animationType="fade"
          transparent={true}
          visible={modalVisible2}
